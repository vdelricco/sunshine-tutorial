...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.settings_temp_units_key),
                mContext.getString(R.string.settings_temp_units_celsius));

        if (unitType.equals(mContext.getString(R.string.settings_temp_units_fahrenheit))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.settings_temp_units_celsius))) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            final String ID = "78b5562a955306eeb8ab5c13f5a32636";
